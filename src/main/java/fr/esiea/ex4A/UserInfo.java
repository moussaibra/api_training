...
public class UserInfo {
    ...
    public UserInfo(@JsonProperty("userCountry") String userCountry,
                    ...
                    @JsonProperty("userSexPref") String userSexPref) { this.userCountry = userCountry;this.userName = userName;this.userEmail = userEmail;this.userTweeter = userTweeter;this.userSex = userSex;this.userSexPref = userSexPref;
    }
    @Override
